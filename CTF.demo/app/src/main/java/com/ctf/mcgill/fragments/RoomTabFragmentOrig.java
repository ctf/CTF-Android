...
public class RoomTabFragmentOrig extends CapsulePageFragment {
    @Nullable
    @Override
     ...
     * number.
     */
    public static RoomTabFragmentOrig newInstance(String roomNumber, String token) {
        RoomTabFragmentOrig fragment = new RoomTabFragmentOrig();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        requestManager.execute(new QueueRequest(token, room), new RoomTabFragmentOrig.QueueRequestListener());
        requestManager.execute(new DestinationsRequest(token), new RoomTabFragmentOrig.DestinationRequestListener());
