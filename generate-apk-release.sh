...
# Note - gradle 3.0.0 generates outputs in their own folders - ctrl + f > release

RELEASE_REPO=ctf/CTF-Android.apk
USER_AUTH=asdfasdfvful
...
cp -a $MODULE_NAME/build/outputs/apk/release/. $HOME/$VERSION_KEY/
printf "Moved apks\n"
