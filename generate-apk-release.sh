...
-X POST --data "data=@$HOME/CTFA/CTF-Android.apk" https://api.github.com/repos/CTFMcGill/CTFMcGill.github.io/releases/$rID/assets?access_token=$GITHUB_API_KEY&name=CTFA-$TRAVIS_BUILD_NUMBER.apk
